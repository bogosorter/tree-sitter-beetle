LANGUAGE_NAME := tree-sitter-beetle
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-beetle
VERSION := 3.0.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/beetle '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/beetle
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/beetle
